    ...
    <footer className="border-t border-[var(--color-border-subtle)] py-10">
      <Container className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        <div className="flex flex-col gap-1">
          <span className="font-mono text-xs font-semibold tracking-widest text-[var(--color-content-primary)]">
            DENIS IL.
          </span>
          <p className="text-xs text-[var(--color-content-muted)]">{tagline}</p>
        </div>

        <div className="flex items-center gap-6">
          <div className="flex items-center gap-4">
            <Link
              href="https://github.com/ilden888"
              target="_blank"
      ...
      <Container className="mt-6">
        <p className="text-xs text-[var(--color-content-muted)]">
          © {new Date().getFullYear()} Denis IL. {rights}
        </p>
      </Container>
    </footer>
  );
