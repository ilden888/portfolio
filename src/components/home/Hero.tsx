...
export function Hero({ t }: HeroProps) {
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[var(--background)]">
      ...
      {/* ── Content ── */}
      <div className="relative z-10 mx-auto flex w-full max-w-[1120px] flex-col items-center px-6 md:px-10">

        {/* Main row: avatar left + text right */}
        <div className="flex w-full flex-col items-center gap-10 md:flex-row md:items-center md:gap-14">

          {/* ── Left: avatar + badge ── */}
          <motion.div {...item(0.05)} className="flex shrink-0 flex-col items-center gap-5">
            <div className="relative">
              ...
              />
              <div className="relative h-32 w-32 overflow-hidden rounded-full border border-[var(--border-12)] ring-2 ring-[var(--border-6)] md:h-36 md:w-36">
                <Image
                  src="/avatar.png"
                  alt="Denis IL"
                  fill
          ...
          <div className="flex flex-col items-center gap-4 text-center md:items-start md:text-left">
            ...
            <motion.p
              {...item(0.15)}
              className="font-mono text-[var(--fg-35)]"
            ...
            <motion.div {...item(0.25)}>
              <h1
                className="font-sans font-semibold leading-[1.05] tracking-[-0.035em]"
            ...
            <motion.h2
              {...item(0.3)}
              className="font-sans font-semibold leading-[1.1] tracking-[-0.035em] text-[var(--foreground)]"
              style={{ fontSize: "clamp(2rem, 5vw, 3.8rem)", whiteSpace: "pre-line" }}
            >
              {t.rest}
            </motion.h2>
            ...
            <motion.p
              {...item(0.38)}
              className="max-w-[460px] leading-relaxed text-[var(--fg-40)]"
            ...
            {/* CTAs */}
            <motion.div {...item(0.46)} className="flex flex-wrap items-center justify-center gap-3 md:justify-start">
              <Link
                href="#projects"
        ...
        <motion.div
          {...item(0.55)}
          className="mt-20 flex w-full flex-wrap items-center justify-center gap-x-6 gap-y-3"
        >
