...
export function ContactCTA({ t }: ContactCTAProps) {
  return (
    <Section className="border-t border-white/[0.04]">
      <Container>
        <div className="relative overflow-hidden rounded-2xl border border-white/[0.07] bg-white/[0.015] px-8 py-16 md:px-16 md:py-20 text-center">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 mt-2">
              <a
                ...
                className="group inline-flex items-center gap-2 rounded-full bg-white px-6 py-2.5 text-sm font-medium text-black transition-all duration-200 hover:bg-white/90"
              >
                <Mail size={14} />
                {t.email}
              </a>
